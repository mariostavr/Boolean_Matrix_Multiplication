...
file_A = fopen('Arrays//data_A.txt','w');
fprintf(file_A,'%d %d %d\n',data_A);
fclose(file_A);

file_B = fopen('Arrays//data_B.txt','w');
fprintf(file_B,'%d %d %d\n',data_B);
fclose(file_B);

file_F = fopen('Arrays//data_F.txt','w');
fprintf(file_F,'%d %d %d\n',data_F);
fclose(file_F);

%WRITING ARRAYS INTO TEXT.
dlmwrite('Arrays//Array_A.txt', a_coo, 'delimiter', ' '); 
dlmwrite('Arrays//Array_B.txt', b_coo, 'delimiter', ' '); 
dlmwrite('Arrays//Filter.txt', f_coo, 'delimiter', ' ');
